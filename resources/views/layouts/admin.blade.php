...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Footer -->
            <footer class="sticky-footer bg-white" style="margin-top: 60vh;">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; BLS Sriwijaya</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="https://cdn.tiny.cloud/1/zzcbr0h0fufkaiz5786p5mxh8jvw9m6jvz2trhqtduwqj1k8/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
    tinymce.init({
        selector:'textarea'
    });
